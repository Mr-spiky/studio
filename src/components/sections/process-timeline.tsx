  ...
  return (
    <Section id="process" className="bg-primary/5">
      ...
      <div className="relative mt-24">
        ...
        <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 -translate-y-1/2" style={{ top: '2rem', background: 'hsl(var(--accent) / 0.2)' }} />
          ...
          {processSteps.map((step, index) => (
            <div key={step.title} className="relative flex flex-col items-center text-center group">
              ...
              {index < processSteps.length - 1 && (
                <div className="md:hidden absolute top-0 left-1/2 w-0.5 h-full -translate-x-1/2" style={{ top: '2rem', background: 'hsl(var(--accent) / 0.2)', zIndex: 0 }} />
              )}
              
              <div className="relative z-10 mb-[-2rem]">
                  <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
              ...
              <Card className="w-full border-t-4 border-accent bg-card shadow-sm pt-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
